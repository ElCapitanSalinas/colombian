  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
     ...
     <a class="dropdown-item" href="https://colombianairways.com/docs/GOM.pdf">Rs & Rs</a>
      ...
      <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Contact">Contact us</a>
    </div>
  </li>
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <i class="fa fa-book"></i> Operations
    </a>   
    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
    <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Awards">Awards</a>
      <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Career">Ranks</a>
      <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Finances">Expenses</a>
    </div>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo SITE_URL ?>/index.php/Acars">Map</a>
  </li>
     <!-- Start Downloads -->
     <?php
     if(!Auth::LoggedIn())
     ...
     <ul>
              <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fa fa-users"></i> Crewcenter
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
           <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Profile">Profile</a>
           <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Pireps/mine">My pireps</a>
           <?php
                    $allbids = SchedulesData::getBids(Auth::$userinfo->pilotid);
                    $counter = (is_array($allbids) ? count($allbids) : 0);
                    if($counter > 0) {
                ?>
                    <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Schedules/Bids">My schedules</a>
                <?php } else { ?>
                    <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/Fltbook">Schedule flights</a>
                <?php } ?>

           <a class="dropdown-item" href="<?php echo SITE_URL ?>/index.php/profile/editprofile">Edit Profile</a>
           <div class="dropdown-divider"></div>
...
<!-- Start Sign In -->
     ...
     ?>
     <li>&nbsp;</li>
     <li><a data-toggle="nav-item" href="https://colombianairways.com"><img src="https://media.discordapp.net/attachments/501578269355671553/781660738522710096/CO.png" alt=""></a></li>
     <li>&nbsp;&nbsp;&nbsp;</li>
