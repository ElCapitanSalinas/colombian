...
<table"width="98%" align="center" cellpadding="4">
	<!-- Flight ID -->
	<tr style="background-color: #094981; color: #FFF;">
...
<tr style="background-color: #094981; color: #FFF; padding: 5px;">
...
<center><a href="http://www.colombianairways.com/index.php/SimBrief"><button type="button" style="width:100%" class="btn btn-primary btn-lg" style="font-size:30px" value="Generate SimBrief">Click to Generate OFP</button></a></center>
<br />
</div>
</section>